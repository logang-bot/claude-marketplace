...
BEGIN {
    ...
    printf "X is obvious\".\n\n"
    printf "Member order is measured too, and has no number to plan around: properties first,\n"
    printf "then constructors, then methods, each block running public before private. A plan\n"
    printf "step that adds a field to an existing class should say where in the class it goes.\n\n"
